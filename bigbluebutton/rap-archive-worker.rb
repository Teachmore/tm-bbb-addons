...
def archive_recorded_meetings(recording_dir)
  ...
  recorded_done_files.each do |recorded_done|
    ...
    ## Modification 1/2 by Deep
    ## Call post archive to delete meeting recording as post archive is called after sanity 
    ## but sanity check is skipped for meeting witout recording marks
    if File.exists?(archived_norecord)
